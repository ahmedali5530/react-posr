...
function loadConfig(env) {
  ...
  return {
    ...
    master: {
      url: getRequired(env, 'SYNC_MASTER_URL'),
      ns: getRequired(env, 'SYNC_MASTER_NS'),
      db: getRequired(env, 'SYNC_MASTER_DB'),
      user: getRequired(env, 'SYNC_MASTER_USER'),
      pass: getRequired(env, 'SYNC_MASTER_PASS'),
    },
    excludeTables,
  };
}
