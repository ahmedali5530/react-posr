...
RecipeScalingScreen,
  ...
  QuantumComputingRestaurantOptimizationScreen,
...
<Route path={REPORTS_PACKAGING_OPTIMIZER} element={<PackagingOptimizerScreen/>}/>
        ...
        <Route path={REPORTS_QUANTUM_COMPUTING_RESTAURANT_OPTIMIZATION} element={<QuantumComputingRestaurantOptimizationScreen/>}/>
